...
public class LastInventory {
    ...
    public static void updateInventoryData(String operation, List<Integer> indexes) {
        MinecraftClient client = MinecraftClient.getInstance();
        if (client.currentScreen == null) return;
        if (!(client.currentScreen instanceof HandledScreen)) { resetInventoryData(); return; }
    ...
    public static void updateFromMainInventory(String operation) {
        updateInventoryData(operation, Indexes.Inventory.TOTAL_INVENTORY);
    }

    public static void updateFromPV(String operation) {
        updateInventoryData(operation, Indexes.PV.TOTAL_INVENTORY);
    }

    public static void updateFromShulker(String operation) {
        updateInventoryData(operation, Indexes.Shulker.TOTAL_INVENTORY);
    }

    public static void updateFromTrade(String operation) {
        updateInventoryData(operation, Indexes.Trade.TOTAL_INVENTORY);
    }
    ...
    public static void showInventoryData() {
        DEBUG.Store("Data about the Inventory:");
