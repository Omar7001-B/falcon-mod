...
public class Naming {
    ...
    private static final String[] NON_STACKABLE_KEYWORDS = {"shears", "potion", "cap", "tunic", "pants", "boots", "totem" ,"bow", "sword", "pickaxe", "axe", "helmet", "chestplate", "leggings", "boots", "shulker", "elytra"};
