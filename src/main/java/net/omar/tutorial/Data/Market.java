...
public class Market {
    ...
    public static Trader cobblestoneToGoldNugget_t = compressOre_P2.addTrade(new Trader(1, "Cobblestone", 16, null, 0, "Gold Nugget", 1));
    public static Trader coalToGoldNugget_t = compressOre_P2.addTrade(new Trader(2, "Coal", 16, null, 0, "Gold Nugget", 2));
    public static Trader ironToGoldNugget_t = compressOre_P2.addTrade(new Trader(3, "Iron Ingot", 8, null, 0, "Gold Nugget", 3));
    public static Trader diamondToGoldNugget_t = compressOre_P2.addTrade(new Trader(4, "Diamond", 3, null, 0, "Gold Nugget", 5));
    public static Trader emeraldToGoldNugget_t = compressOre_P2.addTrade(new Trader(5, "Emerald", 3, null, 0, "Gold Nugget", 6));
    public static Trader ironToRawGold_t = compressOre_P2.addTrade(new Trader(7, "Iron Ingot", 32, "Iron Ingot", 0, "Raw Gold", 2));
    public static Trader diamondToRawGold_t = compressOre_P2.addTrade(new Trader(8, "Diamond", 16, null, 0, "Raw Gold", 3));
    public static Trader emeraldToRawGold_t = compressOre_P2.addTrade(new Trader(9, "Emerald", 16, null, 0, "Raw Gold", 6));
    public static Trader ironToGoldIngot_t = compressOre_P2.addTrade(new Trader(11, "Iron Ingot", 64, "Iron Ingot", 0, "Gold Ingot", 1));
    public static Trader diamondToGoldIngot_t = compressOre_P2.addTrade(new Trader(12, "Diamond", 32, "Diamond", 0, "Gold Ingot", 2));
    public static Trader emeraldToGoldIngot_t = compressOre_P2.addTrade(new Trader(13, "Emerald", 32, "Emerald", 0, "Gold Ingot", 3));
    public static Trader diamondToGoldBlock_t = compressOre_P2.addTrade(new Trader(15, "Diamond", 64, "Diamond", 0, "Gold Block", 1));
    public static Trader emeraldToGoldBlock_t = compressOre_P2.addTrade(new Trader(16, "Emerald", 64, "Emerald", 0, "Gold Block", 2));

    public static Shopper decompressOre_P2 = compressors_P1.addNode(new Shopper("ᴅᴇᴄᴏᴍᴘʀᴇss ᴏʀᴇ"));
    public static Trader goldNuggetToCobblestone_t = decompressOre_P2.addTrade(new Trader(1, "Gold Nugget", 1, null, 0, "Cobblestone", 16));
    public static Trader goldNuggetToCoal_t = decompressOre_P2.addTrade(new Trader(2, "Gold Nugget", 2, null, 0, "Coal", 16));
    public static Trader goldNuggetToIron_t = decompressOre_P2.addTrade(new Trader(3, "Gold Nugget", 3, null, 0, "Iron Ingot", 8));
    public static Trader goldNuggetToDiamond_t = decompressOre_P2.addTrade(new Trader(4, "Gold Nugget", 5, null, 0, "Diamond", 3));
    public static Trader goldNuggetToEmerald_t = decompressOre_P2.addTrade(new Trader(5, "Gold Nugget", 6, null, 0, "Emerald", 3));
    public static Trader rawGoldToIron_t = decompressOre_P2.addTrade(new Trader(7, "Raw Gold", 2, "Iron Ingot", 64, "Iron Ingot", 32));
    public static Trader rawGoldToDiamond_t = decompressOre_P2.addTrade(new Trader(8, "Raw Gold", 3, null, 0, "Diamond", 16));
    public static Trader rawGoldToEmerald_t = decompressOre_P2.addTrade(new Trader(9, "Raw Gold", 6, null, 0, "Emerald", 16));
    public static Trader goldIngotToIron_t = decompressOre_P2.addTrade(new Trader(11, "Gold Ingot", 1, "Iron Ingot", 0, "Iron Ingot", 64));
    public static Trader goldIngotToDiamond_t = decompressOre_P2.addTrade(new Trader(12, "Gold Ingot", 2, "Diamond", 0, "Diamond", 32));
    public static Trader goldIngotToEmerald_t = decompressOre_P2.addTrade(new Trader(13, "Gold Ingot", 3, "Emerald", 0, "Emerald", 32));
    public static Trader goldBlockToDiamond_t = decompressOre_P2.addTrade(new Trader(15, "Gold Block", 1, "Diamond", 0, "Diamond", 64));
    public static Trader goldBlockToEmerald_t = decompressOre_P2.addTrade(new Trader(16, "Gold Block", 2, "Emerald", 0, "Emerald", 64));
